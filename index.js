...
function updateCountdown() {
    ...
    if (timeLeft <= 0) {
        // Birthday has passed
        countdownElement.innerHTML = "<h2>Happy Birthday sir GITA 🍾🎉🎊 you are a blessing to me and the team at large we cant thank you enough . we pray strength and presevation!</h2>";
